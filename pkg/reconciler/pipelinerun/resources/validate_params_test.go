...
// TestValidateUniqueParamsInMatrix tests that a pipeline task does not have
// any duplicate parameters
func TestValidateUniqueParamsInMatrix(t *testing.T) {
	for _, tc := range []struct {
		desc     string
		state    resources.PipelineRunState
		wantErrs string
	}{{
		desc: "parameters are unique",
		state: resources.PipelineRunState{{
			PipelineTask: &v1beta1.PipelineTask{
				Name: "task",
				Params: v1beta1.Params{{
		...
		desc: "parameter duplicated in pipelinetask",
		state: resources.PipelineRunState{{
			PipelineTask: &v1beta1.PipelineTask{
				Name: "task",
				Params: v1beta1.Params{{
					Name: "duplicate", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeString, StringVal: "foo"},
				}, {
					Name: "duplicate", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeString, StringVal: "foo"},
				}},
			},
		}},
		wantErrs: "parameter names must be unique, the parameter duplicate is also defined at params[1].name",
	}, {
		desc: "parameter duplicated in matrix and pipelinetask",
		state: resources.PipelineRunState{{
			PipelineTask: &v1beta1.PipelineTask{
				Name: "task",
				Params: v1beta1.Params{{
				...
				Matrix: &v1beta1.Matrix{
					Params: v1beta1.Params{{
						Name: "duplicate", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeArray, ArrayVal: []string{"foo", "bar"}},
					}, {
						Name: "barfoo", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeArray, ArrayVal: []string{"bar", "foo"}}}},
				},
			},
		}},
		wantErrs: "parameter names must be unique, the parameter duplicate is also defined at matrix.params[0].name",
	}, {
		desc: "parameter duplicated in matrix",
		state: resources.PipelineRunState{{
			PipelineTask: &v1beta1.PipelineTask{
				Name: "task",
				Matrix: &v1beta1.Matrix{
					Params: v1beta1.Params{{
						...
						Name: "duplicate", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeArray, ArrayVal: []string{"bar", "foo"}}}},
				},
			},
		}},
		wantErrs: "parameter names must be unique, the parameter duplicate is also defined at matrix.params[1].name",
	}, {
		desc: "parameter duplicated in matrix include params",
		state: resources.PipelineRunState{{
			PipelineTask: &v1beta1.PipelineTask{
				Name: "task",
				Matrix: &v1beta1.Matrix{
					Include: v1beta1.IncludeParamsList{{
						...
						Params: v1beta1.Params{{
							...
							Name: "duplicate", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeString, StringVal: "bar"},
						}}},
					}},
			},
		}},
				...
				Matrix: &v1beta1.Matrix{
					Include: v1beta1.IncludeParamsList{{
						...
						Params: v1beta1.Params{{
							...
							Name: "foobar", Value: v1beta1.ParamValue{Type: v1beta1.ParamTypeString, StringVal: "bar"},
						}}},
					}},
			},
		}},
		...
		t.Run(tc.desc, func(t *testing.T) {
			err := resources.ValidateUniqueParamsInMatrix(tc.state)
			if (err != nil) && err.Error() != tc.wantErrs {
				t.Errorf("expected err: %s, but got err %s", tc.wantErrs, err)
			}
			if tc.wantErrs == "" && err != nil {
