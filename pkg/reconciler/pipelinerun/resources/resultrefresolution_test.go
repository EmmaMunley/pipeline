...
var pipelineRunState = PipelineRunState{{
	...
	PipelineTask: &v1beta1.PipelineTask{
		Name:    "gTask",
		TaskRef: &v1beta1.TaskRef{Name: "gTask"},
		Matrix: &v1beta1.Matrix{
			Params: v1beta1.Params{{
				Name:  "dResults",
				Value: *v1beta1.NewStructuredValues("$(tasks.dTask.results.dResult[*])"),
			}, {
				Name:  "cResults",
				Value: *v1beta1.NewStructuredValues("$(tasks.cTask.results.cResult[*])"),
			}},
		},
	},
}, {
	...
	PipelineTask: &v1beta1.PipelineTask{
		Name:    "hTask",
		TaskRef: &v1beta1.TaskRef{Name: "hTask"},
		Matrix: &v1beta1.Matrix{
			Params: v1beta1.Params{{
				Name:  "aResult",
				Value: *v1beta1.NewStructuredValues("$(tasks.aCustomPipelineTask.results.aResult)"),
	...
	PipelineTask: &v1beta1.PipelineTask{
		Name:    "iTask",
		TaskRef: &v1beta1.TaskRef{Name: "iTask"},
		Matrix: &v1beta1.Matrix{
			Params: v1beta1.Params{{
				Name:  "iDoNotExist",
				Value: *v1beta1.NewStructuredValues("$(tasks.dTask.results.iDoNotExist[*])"),
			}},
		},
	},
}, {
	...
	PipelineTask: &v1beta1.PipelineTask{
		Name:    "jTask",
		TaskRef: &v1beta1.TaskRef{Name: "jTask"},
		Matrix: &v1beta1.Matrix{
			Params: v1beta1.Params{{
				Name:  "iDoNotExist",
				Value: *v1beta1.NewStructuredValues("$(tasks.aCustomPipelineTask.results.iDoNotExist)"),
			}},
		},
	},
}}
